...
<script type="text/javascript" src="./assets/javascript/piecesMovement.js"></script>
    <?php
        ...
        $whitePawn1 = "<div id='whitePawn1' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn2 = "<div id='whitePawn2' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn3 = "<div id='whitePawn3' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn4 = "<div id='whitePawn4' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn5 = "<div id='whitePawn5' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn6 = "<div id='whitePawn6' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn7 = "<div id='whitePawn7' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        $whitePawn8 = "<div id='whitePawn8' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x2659;</div>";
        ...
        $blackPawn1 = "<div id='blackPawn1' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x265F;</div>";
        $blackPawn2 = "<div id='blackPawn2' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x265F;</div>";
        $blackPawn3 = "<div id='blackPawn3' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x265F;</div>";
        $blackPawn4 = "<div id='blackPawn4' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x265F;</div>";
        $blackPawn5 = "<div id='blackPawn5' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x265F;</div>";
        $blackPawn6 = "<div id='blackPawn6' class='piece pawn first' draggable='true' ondragstart=\"drag(event)\">&#x265F;</div>";
